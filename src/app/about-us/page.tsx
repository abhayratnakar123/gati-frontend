...
const AboutUs: React.FC = () => {
  return (
    ...
    >
    <section
      className="flex flex-col items-center justify-center bg-primary500 bg-[url('/images/website/inner-pattern.png')] bg-cover bg-no-repeat p-6 text-center md:min-h-50">
        <h1 className="text-3xl font-bold text-white lg:text-5xl">About Us</h1>
